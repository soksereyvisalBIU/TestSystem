...
// --- Sub Components (Normally imported) ---
// Note: Ensure you include the AnimatedCounter and AssessmentResultCard code here
// or import them if you split the files.
// import { AssessmentResultCard } from './Components/AssessmentResultCard';
// import { AnimatedCounter } from './Components/AnimatedCounter'; // Used in countdown too
...
// --- Custom Hook: Server Time Sync ---
const useServerTime = () => {
    const [now, setNow] = useState<dayjs.Dayjs | null>(null);

    useEffect(() => {
        // Initial fetch simulation (Replace with real API call if needed)
...
export default function AssessmentConfirmPage({
    ...
    // Add this check near the top of your return or render logic
    if (!serverNow) {
        return (
            <AppLayout>
    ...
    const { logic, countdown } = useMemo(() => {
        if (!assessment || !serverNow) return { logic: null, countdown: null };
                                ...
                                {showResult ? (
                                    ...
                                    >
                                        <AssessmentResultCard
                                            score={scorePercentage} // Passing percentage, or pass rawScore if preferred
                                            maxScore={100} // If displaying percentage
                                            isPassing={isPassing}
                                            completedAt={
