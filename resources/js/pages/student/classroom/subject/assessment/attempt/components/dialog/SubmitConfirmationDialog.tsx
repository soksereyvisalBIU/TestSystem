...
import { Save, AlertCircle, CheckCircle2, ArrowRight, Loader2 } from 'lucide-react';
...
export function SubmitConfirmationDialog({
    ...
    const handleSubmit = async () => {
        ...
        try {
            await onConfirm(); // submit logic (Inertia, axios, fetch, etc.)
        } catch (error) {
                ...
                <div className="bg-white p-8 dark:bg-zinc-900">
                    ...
                    <DialogFooter className="flex flex-col gap-3 sm:flex-col">
                        <Button
                            ...
                            className={cn(
                                "h-16 w-full rounded-2xl text-md sm:text-lg font-black transition-all active:scale-95 flex items-center justify-center gap-3",
