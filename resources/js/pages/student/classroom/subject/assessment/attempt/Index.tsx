...
export default function AssessmentAttempt({
    ...
    return (
        <div 
            className={cn('min-h-screen transition-colors duration-500 bg-background text-body')}
        ...
        >
            ...
            <div className="mx-auto flex max-w-7xl gap-8 px-4 py-8">
                <main className={cn('flex-1 space-y-4 pb-32 transition-all', isFocusMode && 'mx-auto max-w-3xl')}>
                                ...
                                >
                                    <QuestionCard
                                        ...
                                        renderQuestion={(question, idx, ans, onChange, disabled) => (
                                            <QuestionRenderer
                                                question={question} index={idx} answer={ans}
                                                onAnswerChange={onChange} disabled={disabled}
                                            />
                                        )}
                                    />
                                    {viewMode === 'single' && (
                                        <SingleViewNavigation
                                            ...
                                            onPrevious={goToPrev} onNext={goToNext}
            ...
            <FloatingTools 
                fontSize={fontSize} isFocusMode={isFocusMode}
