...
export function QuestionCard({
    ...
    return (
        <section
            ref={questionRef}
            className={cn(
                'relative overflow-hidden rounded-[3rem] border p-8 transition-all duration-100 md:p-12',
                // Theme-aware states: Active or Single view get full highlight
        ...
        >
            ...
            <div className="mb-5 flex items-center justify-between">
                ...
                <div className={cn(
                    ...
                    {hasAnswer ? (
                        <><CheckCircle2 className="h-3.5 w-3.5" /> <span>Selection Saved</span></>
                    ) : (
                        <><Circle className="h-3.5 w-3.5" /> <span>Unanswered</span></>
                    )}
                </div>
            </div>
            ...
            {/* REMOVED: Inactive Overlay that was blocking clicks */}
        </section>
    );
}