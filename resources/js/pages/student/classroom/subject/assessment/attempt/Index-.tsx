    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-8">
                <div className="relative flex-1 overflow-hidden rounded-xl border border-sidebar-border/70 bg-card p-8 dark:border-sidebar-border">
                    <div className="mb-6">
                        ...
                        <div className="mt-2 text-sm text-muted-foreground">
                            ...
                            <p>
                                Attempts Allowed: {assessment.max_attempts} |
                                Start: {assessment.start_at} | End:{' '}
                                {assessment.end_at}
                            </p>
                        </div>
                    </div>
