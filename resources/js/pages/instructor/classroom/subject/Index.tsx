...
export default function SubjectDetail({ subject }: { subject: any }) {
    ...
    const assessments = subject?.assessments || [
        ...
        { id: 1, title: 'Midterm Exam', type: 'Exam', due: 'Oct 12, 2025', status: 'completed', score: 85 },
        { id: 2, title: 'Chapter 1 Quiz', type: 'Quiz', due: 'Nov 05, 2025', status: 'upcoming', score: null },
    ];
                                            ...
                                            >
                                                ...
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <Button variant="ghost" size="icon" asChild>
                                                        <Link href={route('instructor.classes.subjects.assessments.show', [subject?.class_id, id, assessment.id])}>
