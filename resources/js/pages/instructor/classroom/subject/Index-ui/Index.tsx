                ...
                >
                    ...
                    <div className="relative z-10 flex flex-col justify-end p-8 md:h-72 lg:h-80">
                        ...
                        >
                            <Badge
                                variant="secondary"
                                className="border-0 bg-blue-500/20 text-blue-100 hover:bg-blue-500/30"
                            >
                                {subject?.year || '2025'}
                            </Badge>
                            <Badge
                            ...
                            >
                                <Clock className="h-3 w-3" /> Mon & Wed • 8:00
                                AM
                            </Badge>
                        </motion.div>
                        ...
                        <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
                            ...
                            >
                                ...
                                <p className="line-clamp-2 max-w-2xl text-lg text-slate-300">
                                    {subject?.description ||
                                        'Advanced concepts in software engineering and system design patterns.'}
                                </p>
                            </motion.div>
                ...
                <Tabs defaultValue="overview" className="w-full space-y-6">
                    ...
                    <TabsContent value="overview" className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                            <Card className="col-span-1 border-slate-100 shadow-sm lg:col-span-2">
                                <CardHeader>
                                    <CardTitle>Recent Activity</CardTitle>
                                    <CardDescription>
                                        Latest updates from assessments and
                                        students.
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                                ...
                                <CardContent className="space-y-4">
                                    {assessments
                                        ...
                                        .map((a: any, i: number) => (
                                            <div
                                                key={i}
                                                className="flex items-start gap-3 rounded-lg border bg-slate-50/50 p-3"
                                            >
                        ...
                        <Card className="border-slate-100 shadow-sm">
                            ...
                            <CardContent className="space-y-4">
                                {assessments.map((a: any) => (
                                    <div
                                        key={a.id}
                                        className="group flex flex-col justify-between rounded-xl border p-4 transition-all hover:border-blue-200 hover:bg-blue-50/30 hover:shadow-sm md:flex-row md:items-center"
                                    >
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center gap-6">
                                                <div className="hidden text-right sm:block">
                                                    ...
                                                    <span
                                                        className={`text-sm font-semibold ${student.attendance < 80 ? 'text-red-500' : 'text-green-600'}`}
                                                    >
                                                        {student.attendance}%
                                                    </span>
                                                </div>
                    ...
                    <TabsContent value="reports">
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                            {[
                                ...
                                <Card
                                    key={i}
                                    className="cursor-pointer border-slate-200 transition hover:shadow-md"
                                >
